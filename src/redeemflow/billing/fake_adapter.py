"""Billing domain — fake adapter for testing.

In-memory BillingPort implementation with deterministic behavior.
Zero network calls. Mirrors Stripe webhook event handling.
"""
...
class FakeBillingAdapter:
    """In-memory billing adapter for testing."""
    ...
    def create_subscription(self, user_id: str, tier: SubscriptionTier | None = None, **kwargs: Any) -> Subscription:
        ...
        stripe_id = f"sub_fake_{uuid.uuid4().hex[:8]}"
    ...
    def subscription_count(self) -> int:
        """Number of subscriptions (test inspection)."""
